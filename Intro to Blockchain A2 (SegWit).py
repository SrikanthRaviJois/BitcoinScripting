...
try:
    ...
    segwit_address_A = rpc_connection.getnewaddress("", "p2sh-segwit")
    segwit_address_B = rpc_connection.getnewaddress("", "p2sh-segwit")
    segwit_address_C = rpc_connection.getnewaddress("", "p2sh-segwit")
